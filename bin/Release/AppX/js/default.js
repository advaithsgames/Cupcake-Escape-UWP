    ...
    function onVisibilityChanged(args) {
        ...
        if (!document.hidden && !runtimeCreated) {
            ...
            if (!runtimeCreated) {
                ...
                window.Runtime.onInit(document.getElementById('FusionRoot'), document.getElementById('FusionCanvas'), document.getElementById('FusionContainer'), '../resources/Cupcake Escape! UWP.cch', _scope);
